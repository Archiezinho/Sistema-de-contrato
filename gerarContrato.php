...
<div class="container">
    ...
    ?>
    <h4 class="text-center text-dark pt-2">Gerar Contrato de Trabalho</h3>
	<div class="form-group">
            Pesquisar: <input type="text" class="form-control" id="busca" placeholder="Informe o Nome">
        </div>
	
        <form action="folhasPdf/contratoTrabalho.php" method="Post">
        <div class="form-group">
        ...
        <br>
			...
			<input  class="btn btn-primary" name="ficha" type="submit" value="Emitir Contrato">  
        </form>
