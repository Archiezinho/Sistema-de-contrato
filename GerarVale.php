...
<div class="container">
    ...
    ?>
    <h4 class="text-center text-dark pt-2">Gerar Vale de Transporte</h3>
	<div class="form-group">
            Pesquisar: <input type="text" class="form-control" id="busca" placeholder="Informe o Nome">
        </div>
	
        <form action="folhasPdf/valeTransporte.php" method="Post">
        <div class="form-group">
        ...
        <br>
			...
			<input  class="btn btn-primary" name="ficha" type="submit" value="Emitir Vale">  
        </form>
